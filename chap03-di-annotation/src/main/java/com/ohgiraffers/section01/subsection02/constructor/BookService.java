...
public class BookService {
    ...
    위의 코드에서 기본 생성자를 추가로 작성하고 매개 변수 생성자에 @Autowired 어노테이션을 생략하게 되면 생성자 주입이
    동작하지 않아 오류가 밣생된다.
    *
    생성자 주입의 장점
    객체가 생성 될때 모든 의존성이 주입 되므로 의존성을 보장할 수 있다.
    ...
    코드 가독성이 좋다.
    해당 객체가 어떤 의존성을 가지고 있는지 명확히 알수 있다.
    DI 컨테이너와 결합도가 낮기 때문에 테스트하기 좋다.
